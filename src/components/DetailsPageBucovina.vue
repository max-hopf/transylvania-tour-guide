...
import heroImg from '../assets/activity-title-images/bucovina-title-img.jpg';
...
const bucovinaTabs = [
  ...
  {
    label: `Flexibility and Extensions`,
    content: `
